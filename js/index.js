...
//柱状图2  右边的
(function () {
    let myColors = ["#1089e7", "#f57474", "#56d0e3", "#f8b448", "#8b78f6"]
    let myCharts = echarts.init(document.querySelector(".column .bar2 .chart"));
    let option = {
        grid: {
            top: '10%',
            left: '22%',
    ...
    let yearData = [
        {
            year: "2020",
            data: [
                [24, 40, 101, 134, 90, 230, 210, 230, 120, 230, 210, 230],
                ...
                areaStyle: {
                    color: new echarts.graphic.LinearGradient(0, 0, 0, 1,
                        [
                            {
                                offset: 0,
                                color: "rgba(0,216,135,0.4)"  //起始颜色
                            }, {
                                offset: 0,
                                color: "rgba(0,216,135,0.1)"  //结束颜色
                            }
                        ], false),
                    shadowColor: "rgba(255,255,255,0.1)"
                },
...
(function () {
    ...
    let option = {
        ...
        legend: {
            ...
            itemHeight: 10,
            textStyle: {//修改图标文字大小颜色
                fontSize: "10",
                color: "rgba(255,255,255,0.5)"
            }
            // 此处data可以省略，只要series 里面数据有name  属性就可以了
            // data: ['直接访问', '邮件营销', '联盟广告']
        },
        series: [
            {
...
// 中间的地图  模拟飞行路线
(function () {
    let myCharts = echarts.init(document.querySelector(".map .chart"));
    ...
    var XAData = [
        [{ name: "西安" }, { name: "渭南", value: 100 }],
        [{ name: "西安" }, { name: "台州", value: 100 }],
